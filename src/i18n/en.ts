...
export const en: Translations = {
    ...
    brewing: {
        ...
        flaskHint: "⚗ Cursed Vial ready — click a white token to return it to your bag",
        riskLevel: "Risk",
    },
    ...
    rubySpend: {
        ...
        proceedToMarket: "✦ Proceed to Market ✦",
    },
    ...
    exploded: {
        ...
        lastIngredient: "Keep last ingredient's effect",
        oneVP: "Gain 1 Victory Point",
    },
    ...
    grimoire: {
        ...
        omensIntro: "At the start of each round, one Omen Card is drawn from a shuffled deck of 9. Its effect applies to all players for the entire round. Reading the Omen before you brew is not optional — it is the first rule of survival.",
        cardsLabel: "Cards:",
        ...
        plaguedustSub: "Black — Toxic Spore",
        wraithbloomSub: "Purple — Spectral Petal",
        shadowmossSub: "Yellow — Gilded Lichen",
    ...
    grimoireIngredientsData: {
        ...
        Brimstone: {
            ...
            effect: "Safe ingredient — advances the spiral without adding to Voidshard pressure. No special effect. Higher value Brimstone chips push further along the track, earning more VP and coins.",
        ...
        Deathweave: {
            ...
            effect: "End-of-round effect: If a Deathweave chip is placed on the last or second-to-last space of your crucible, you earn 1 ruby. Rubies can be spent between rounds to advance your droplet or refill your Cursed Vial.",
        ...
        Wraithbloom: {
            ...
            effect: "End-of-round effect: If your crucible survives (does not explode), gain +1 VP for every Wraithbloom chip placed in your crucible this round. Useless if you explode — only rewards survival.",
        ...
        Frostbile: {
            ...
            effect: "Immediate effect: When a Frostbile chip is drawn, draw additional chips from your bag equal to its value (1, 2, or 4 extra draws). Choose one to keep and place in the crucible. Return the rest to your bag. Powerful for bag manipulation.",
        ...
        Bloodthorn: {
            ...
            effect: "Immediate effect: When a Bloodthorn chip is drawn, it advances 1 extra space for every other Bloodthorn chip already placed in your crucible. The more Bloodthorns in your pot, the further each new one pushes. Combos stack aggressively.",
        ...
        Plaguedust: {
            ...
            effect: "Immediate effect: When a Plaguedust chip is placed, earn 1 ruby for every pair of Plaguedust chips already in your crucible this round. Stacking multiple yellows in a single brew gives escalating ruby income.",
        ...
        Shadowmoss: {
            ...
            effect: "End-of-round effect: If your crucible survives and a Shadowmoss chip is in the pot, your droplet advances 1 space forward permanently — for free. This is the same benefit as spending 2 rubies, but costs nothing.",
